...
public void insert(int key)
	{
		...
		promote(leaf,key,null);
		 System.out.print("---------------\n");
                 try{  
                     File fle = new File("C:\\Users\\achuu\\Desktop\\FileStructures-B-Trees--master\\CMS\\traverse.txt");
		  ...
		  System.out.print("---------------- \n");
                  try{ 
                      FileWriter fw=new FileWriter("C:\\Users\\achuu\\Desktop\\FileStructures-B-Trees--master\\CMS\\traverse.txt",true);
                        fw.write("-----------------\n");
                        fw.close();
                    }
                    catch(Exception e)
...
public void insert1(int key)
	{
		...
		promote(leaf,key,null);
		 System.out.print("---------------\n");
                 try{  
                     File fle = new File("C:\\Users\\achuu\\Desktop\\FileStructures-B-Trees--master\\CMS\\traverse1.txt");
                     if (fle.createNewFile()){
                     System.out.println("File is created!");
                    }else{
                    System.out.println("File already exists.");
		  ...
		  System.out.print("---------------- \n");
                  try{ 
                      FileWriter fw=new FileWriter("C:\\Users\\achuu\\Desktop\\FileStructures-B-Trees--master\\CMS\\traverse1.txt",true);
                        fw.write("-----------------\n");
                        fw.close();
                    }
                    catch(Exception e)
...
no1=0;
try {
          File fle = new File("C:\\Users\\achuu\\Desktop\\FileStructures-B-Trees--master\\CMS\\bpluss.txt");
          if (fle.createNewFile()){
            System.out.println("File is created!");
            }else{
            System.out.println("File already exists.");
...
BufferedReader reader = new BufferedReader(new FileReader("C:\\Users\\achuu\\Desktop\\FileStructures-B-Trees--master\\CMS\\bpluss.txt"));
String line;
